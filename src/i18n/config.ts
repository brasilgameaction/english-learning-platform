    ...
    resources: {
      pt: {
        translation: {
          ...
          'admin.changePassword.title': 'Alterar Senha',
          'admin.changePassword.button': 'Alterar Senha',
          'admin.changePassword.currentPassword': 'Senha Atual',
          'admin.changePassword.newPassword': 'Nova Senha',
          'admin.changePassword.confirmPassword': 'Confirmar Nova Senha',
          'admin.changePassword.submit': 'Salvar',
          'admin.changePassword.success': 'Senha alterada com sucesso!',
          'admin.changePassword.error.allRequired': 'Todos os campos são obrigatórios',
          'admin.changePassword.error.passwordsMismatch': 'As senhas não coincidem',
          'admin.changePassword.error.passwordTooShort': 'A senha deve ter pelo menos 6 caracteres',
          'admin.changePassword.error.currentPasswordInvalid': 'Senha atual incorreta',
          'admin.changePassword.error.general': 'Erro ao alterar a senha',
      ...
      en: {
        translation: {
          ...
          'admin.changePassword.button': 'Change Password',
          'admin.changePassword.currentPassword': 'Current Password',
          'admin.changePassword.newPassword': 'New Password',
          'admin.changePassword.confirmPassword': 'Confirm New Password',
          'admin.changePassword.submit': 'Save',
          'admin.changePassword.success': 'Password changed successfully!',
          'admin.changePassword.error.allRequired': 'All fields are required',
          'admin.changePassword.error.passwordsMismatch': 'Passwords do not match',
          'admin.changePassword.error.passwordTooShort': 'Password must be at least 6 characters long',
          'admin.changePassword.error.currentPasswordInvalid': 'Current password is incorrect',
          'admin.changePassword.error.general': 'Error changing password',
